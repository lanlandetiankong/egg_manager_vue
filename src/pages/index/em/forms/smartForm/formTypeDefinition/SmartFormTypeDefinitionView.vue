    ...
    export default {
        ...
        data() {
            ...
            const fieldInfoConfObj = {
                name:{
                    fieldLabel:this.$t('langMap.table.fields.em.formType.formTypeName'),
            ...
            return {
                ...
                searchConf:{
                    ...
                    formItemConf:{
                        name:{
                            ...
                            label:this.$t('langMap.table.fields.em.formType.formTypeName'),
                ...
                tableConf: {
                    data: [],
                    columns: [{
                        title: this.$t('langMap.table.fields.em.formType.formTypeName'),
                ...
                drawerConf:{
                    detail:{
                        defaultGridItem:{
                            conf:{
                                title:this.$t('langMap.drawer.em.title.detailForDefineFormType'),
                            },
                            visible:false,
                            dataObj:{},
        ...
        methods: {
            dealGetDialogRefFormObj() {    //返回 弹窗表单 的form对象
                return this.$refs.smartFormTypeDefinitionCreateFormCompRef.createForm;
            },
            ...
            handleSearchFormQuery(e,values) {   //带查询条件 检索数据列表
                ...
                SmartFormTypeDefinitionApi.getPageQuery(searchFieldArr,_this.tableConf.pagination,_this.tableConf.sorter).then((res) => {
                    if (res) {
