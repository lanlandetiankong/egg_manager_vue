...
export const MenuManagerApi = {
    ...
    getDefineMenuById(defineMenuId){  //根据菜单id查询菜单信息
        ...
        return axios.post("/define/define_menu/getDefineMenuById",qs.stringify(params)).then(res => res) ;
    },
    addDefineMenuByForm(formObj) {     //新增菜单
        return axios.post("/define/define_menu/doAddDefineMenu",qs.stringify(formObj));
    },
    ...
    batchDelDefineMenu(ids) {  //批量删除
        ...
        return axios.post("/define/define_menu/batchDelDefineMenuByIds",qs.stringify(obj,{indices: false})).then(res => res) ;
    },
    delOneDefineMenu(delId) {  //删除
        var obj = {
            delId:delId
        }
        return axios.post("/define/define_menu/delOneDefineMenuById",qs.stringify(obj,{indices: false})).then(res => res) ;
    }
}
