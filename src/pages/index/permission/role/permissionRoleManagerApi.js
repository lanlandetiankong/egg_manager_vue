...
export const PermissionRoleManagerApi = {
    ...
    getAllMenuByRoleId(defineRoleId){  //根据角色id查询角色所拥有的[菜单定义]列表
        ...
        return axios.post("/define/define_role/getAllMenuByRoleId",qs.stringify(params)).then(res => res) ;
    },
    ...
    grantMenusToRole(roleId,checkIds,halfCheckIds){     //[菜单授权]提交
        ...
        return axios.post("/define/define_role/grantMenusToRole",qs.stringify(obj,{indices: false})).then(res => res) ;
    }
}
