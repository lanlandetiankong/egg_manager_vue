...
export const PermissionRoleManagerApi = {
    getAllDefineRoles(queryArr,pagination,sorter) {
        ...
        //查询所有角色信息
        return axios.post('/define/defineRole/getAllDefineRoleDtos',qs.stringify(obj)).then(res => res.data);
    },
    getDefineRoleById(defineRoleId){  //根据角色id查询角色信息
        var params = {
            defineRoleId:defineRoleId
        }
        return axios.post("/define/defineRole/queryOneById",qs.stringify(params)).then(res => res.data) ;
    },
    getAllPermissionByRoleId(defineRoleId){  //根据角色id查询角色所拥有的[权限定义]列表
        var params = {
            defineRoleId:defineRoleId
        }
        return axios.post("/define/defineRole/gainAllPermissionByRoleId",qs.stringify(params)).then(res => res.data) ;
    },
    getAllDefinePermissions() {     //取得所有定义的权限
        ...
        //查询所有权限信息
        return axios.post('/define/definePermission/queryPage',qs.stringify(obj)).then(res => res.data);
    },
    ...
    delOneDefineRole(delId) {  //删除
        ...
        return axios.post("/define/defineRole/deleteById",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    },
    grantPermissionToRole(roleId,checkIds){     //角色授权提交
        ...
        return axios.post("/define/defineRole/grantPermissionToRole",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    },
    grantMenusToRole(roleId,checkIds,halfCheckIds){     //[菜单授权]提交
        ...
        return axios.post("/define/defineRole/grantMenusToRole",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    }
}
