    ...
    <div>
        ...
        <div>
            <smart-form-type-defintion-create-form-comp
                ref="smartFormTypeDefintionCreateFormCompRef"
...
<script>
    ...
    import {SmartFormTypeDefintionDrawerConf} from './drawer_conf.js'
    import AFormItem from "ant-design-vue/es/form/FormItem";
    import ACol from "ant-design-vue/es/grid/Col";

    import {SmartFormTypeDefinitionApi} from './smartFormTypeDefinitionApi.js'

    import SmartFormTypeDefintionCreateFormComp from "@/components/index/forms/smartForm/formTypeDefinition/SmartFormTypeDefintionCreateFormComp";
    import SimpleDetailDrawerComp from '~Components/index/common/drawer/SimpleDetailDrawerComp';

    export default {
        name: "SmartFormTypeDefintionView",
        components: {SmartFormTypeDefintionCreateFormComp,SimpleDetailDrawerComp, ACol, AFormItem},
        data() {
            return {
                searchConf:{
                    showListFlag:false,
                ...
                drawerConf:{
                    detail:{
                        defaultGridItem:{
                            ...
                            dataObj:{},
                            drawerFieldConf:SmartFormTypeDefintionDrawerConf
                        },
                    },
                },
            }
        ...
        methods: {
            ...
            dealGetDialogRefFormObj() {    //返回 弹窗表单 的form对象
                return this.$refs.smartFormTypeDefintionCreateFormCompRef.smartFormTypeDefintionCreateForm;
            },
